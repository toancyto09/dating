    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "white", alignItems: "center" }}>
      ...
      <KeyboardAvoidingView>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <Pressable onPress={handleLogin} style={{ width: 200, backgroundColor: "#FFC0CB", borderRadius: 6, marginLeft: "auto", marginRight: "auto", padding: 15 }}>
            <Text style={{ textAlign: "center", color: "white", fontSize: 16, fontWeight: "bold" }}>Login</Text>
          </Pressable>

          <Pressable onPress={() => router.replace("/register")} style={{ marginTop: 12 }}>
            <Text style={{ textAlign: "center", color: "gray", fontSize: 16 }}>Don't have an account?</Text>
          </Pressable>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
